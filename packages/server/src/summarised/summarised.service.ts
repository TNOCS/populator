    ...
    const buurtData = this.summarisedRepository
      .query(
        `select json_build_object(
          ...
          from (select gid, bu_naam, b.bu_code, wk_naam, gm_naam, postcode, aant_inw as t_res, aant_werkenden as t_non_res, t_00_14_jr, t_15_24_jr, t_25_44_jr, t_45_64_jr, t_65_eo_jr, aantal_hh, t_eenp_hh, t_hh_z_k, t_hh_m_k, gem_hh_gr, geovlak 
          ...
          UNION ALL
          select gid, bu_naam, bu_code, wk_naam, gm_naam, postcode, aant_inw as t_res, aant_werkenden as t_non_res, t_00_14_jr, t_15_24_jr, t_25_44_jr, t_45_64_jr, t_65_eo_jr, aantal_hh, t_eenp_hh, t_hh_z_k, t_hh_m_k, gem_hh_gr, geovlak 
